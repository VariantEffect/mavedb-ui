<template>
  <div class="collection-creator">
    ...
    <div class="flex flex-column gap-2">
      ...
      <InputSwitch v-model="collectionPrivate" :aria-labelledby="$scopedId('private-help')" :input-id="$scopedId('private-input')" />
      <small :id="$scopedId('private-help')">Private collections are only visible to you and anyone you select as a contributor.</small>
    </div>
    ...
    <div class="contributors-adder">
      ...
      <div class="flex flex-column gap-2">
        ...
        >
          ...
          <div>
            <div v-if="slotProps.value.firstName || slotProps.value.lastName">
              {{ slotProps.value.firstName }} {{ slotProps.value.lastName }} ({{ slotProps.value.orcidId }})
            </div>

          ...
          <StepperPanel v-if="itemStatus == 'NotLoaded' || this.item.private">
            ...
            <template #content="{prevCallback: showPreviousWizardStep, nextCallback: showNextWizardStep}">
              <div class="mavedb-wizard-form">
                ...
                <div class="mavedb-wizard-row">
                  <div class="mavedb-wizard-help">
                    <label :id="$scopedId('input-scoreSetIsSequenceBasedLabel')">Will you be uploading synthetic target sequences with your targets?</label>
                    <div class="mavedb-help-small">
                      The target sequence is the sequence that was mutagenized to create the variant library. If your variants were generated using saturation
                      genome editing or base editing, you might provide an Ensembl or RefSeq accession instead of uploading your own target sequence.
                    </div>
                  </div>
                  <div class="mavedb-wizard-content">
                    <InputSwitch v-model="isTargetSequence" :aria-labelledby="$scopedId('input-scoreSetIsSequenceBasedLabel')" />
                    <div class="mavedb-switch-value">{{ isTargetSequence ? 'Yes, variants are described relative to a synthetic target.' : 'No, variants are described relative to a RefSeq or Ensembl accession.' }}</div>
                  </div>
                </div>
                ...
                <div class="mavedb-wizard-row">
                  <div class="mavedb-wizard-help">
                    ...
                    <div class="mavedb-help-small">
                      ...
                      from this target in the future. Many users choose to name the target after the gene in which it appears.
                    </div>
                  </div>
                  <div class="mavedb-wizard-content field">
                      <span class="p-float-label">
                ...
                <div v-if="isTargetSequence">
                  <div v-if="numTargets > 1" class="mavedb-wizard-row">
                    <div class="mavedb-wizard-help">
                      ...
                      <div class="mavedb-help-small">
                        This label is what you use in your variants file to indicate which of your targets the variant is described relative to. Because it is used with hgvs strings,
                        it may not contain any spaces or colons.
                      </div>
                    </div>
                      <div class="mavedb-wizard-content field">
                        <span class="p-float-label">
                  ...
                  <div class="mavedb-wizard-row">
                    <div class="mavedb-wizard-help">
                      <label :id="$scopedId('input-targetGeneCategory')">The genetic category of the target</label>
                    </div>
                    <div class="mavedb-wizard-content">
                      <span class="p-float-label">
                        <span class="p-float-label">
                  ...
                  <div class="mavedb-wizard-row">
                    <div class="mavedb-wizard-help">
                      ...
                      <div class="mavedb-help-small">
                        Variants will be validated against this sequence. Note that the first position in the sequence is position 1.
                      </div>
                    </div>
                    <div class="mavedb-wizard-content">
                      <span class="p-float-label">
                        <FileUpload ref="sequenceFileUpload"
                          ...
                          <template #empty>
                            <div v-if="createdTargetGenes[targetIdx].targetGene.targetSequence.sequence != null" >
                              <Textarea v-model="createdTargetGenes[targetIdx].targetGene.targetSequence.sequence" rows=5 disabled style="width:100%" />

<template>
  <header class="border-b border-border bg-white px-6" :class="paddingClass">
  ...
  computed: {
    ...
    titleClasses(): string {
      switch (this.variant) {
        ...
        case 'editor':
          return 'font-display text-3xl font-bold leading-snug text-text-dark'
        default:
          return 'mb-2.5 font-display text-3xl font-bold text-text-dark'
      }
    }
  }
})
